                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 2 }}>
                                <Grid item xs={6}>
                                    <TextField
                                        ...
                                        defaultValue={props.values.personalDetails[0].firstName}
                                    />
                                </Grid>
                                <Grid item xs={6}>
                                    <TextField
                                        ...
                                        name="lastName"
                                        onChange={(e) => props.handleAllChange({ type: 'handleChange', payload: 'personalDetails', eventArg: e })}
                                        defaultValue={props.values.personalDetails[0].lastName}
                                    />
                            ...
                            <TextField
                                ...
                                fullWidth
                                onChange={(e) => props.handleAllChange({ type: 'handleChange', payload: 'personalDetails', eventArg: e })}
                                defaultValue={props.values.personalDetails[0].email}
                            />
                            ...
                            <TextField
                                ...
                                fullWidth
                                onChange={(e) => props.handleAllChange({ type: 'handleChange', payload: 'personalDetails', eventArg: e })}
                                defaultValue={props.values.personalDetails[0].linkedIn}
                            />
                            <br />
                            <br />
                            <TextField
                                ...
                                fullWidth
                                onChange={(e) => props.handleAllChange({ type: 'handleChange', payload: 'personalDetails', eventArg: e })}
                                defaultValue={props.values.personalDetails[0].phoneNumber}
                            />
                            <br />
                            <br />
                            <TextField
                                ...
                                maxRows={4}
                                fullWidth
                                defaultValue={props.values.personalDetails[0].professionalSummary}
                                onChange={(e) => props.handleAllChange({ type: 'handleChange', payload: 'personalDetails', eventArg: e })}
                            />
                            <br />
                            <br />
